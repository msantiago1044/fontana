...
(function () {
    ...
    <a href="/" class="sh-logo" aria-label="Ir a inicio">
      <svg width="26" height="26" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
        <defs>
          <radialGradient id="shCoinGrad" cx="38%" cy="32%" r="75%">
            <stop offset="0%" stop-color="#f2dca0"/>
            <stop offset="55%" stop-color="#c9a14a"/>
            <stop offset="100%" stop-color="#93732e"/>
          </radialGradient>
        </defs>
        <circle cx="16" cy="16" r="14" fill="none" stroke="#c9a14a" stroke-width="1.1" opacity="0.45"/>
        <circle cx="16" cy="16" r="10.5" fill="url(#shCoinGrad)" stroke="#f2dca0" stroke-width="0.6" stroke-opacity="0.5"/>
      </svg>
