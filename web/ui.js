...
const I18N = {
  es: {
    ...
    footer: {
      how: "CÃ³mo funciona", roadmap: "Roadmap",
      terms: "TÃ©rminos y condiciones", privacy: "Privacidad", refunds: "Reembolsos", contact: "Contacto",
      fine: "Fontana es un servicio de inspiraciÃ³n y acompaÃ±amiento personal apoyado en inteligencia artificial. No constituye asesorÃ­a financiera, mÃ©dica, legal ni psicolÃ³gica, y no garantiza el cumplimiento de ningÃºn deseo o resultado. Debes tener 18 aÃ±os o mÃ¡s para usar este servicio. © {year} Fontana."
    },
